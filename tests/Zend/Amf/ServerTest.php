 ...
 * @version    $Id: ServerTest.php 24206 2011-07-06 13:52:02Z matthew $
 */
...
class Zend_Amf_ServerTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testClassMap()
    {
        ...
        $className = $this->_server->getTypeMapper()->getRemoteClassName('Zend_Amf_testclass');
